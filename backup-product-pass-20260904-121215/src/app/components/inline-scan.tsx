...
export default function InlineScan({
  ...
  const steps = [
    ...
    },
    {
      title:
        pageCount !== null
          ? `${pageCount} ${pageCount === 1 ? "Seite" : "Seiten"} technisch prüfen`
          : "Technische Signale prüfen",
      detail: "HTTP, Indexierung, Seitendaten, Links und Zugänglichkeit.",
      state:
        stage === "discovering"
          ? "pending"
          : stage === "scanning"
      ...
      {phase === "scanning" && (
        <section className="wf-scan-v2-progress" aria-live="polite">
          ...
          <p className="wf-scan-v2-footnote">
            WebsiteFix zeigt hier nur echten Scan-Fortschritt. Es werden keine
            künstlichen Seitenzähler oder KI-Schritte simuliert.
          </p>
        </section>
      )}
