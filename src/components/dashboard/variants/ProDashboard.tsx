...
export default function ProDashboard(props: ProDashboardProps) {
  ...
  // Anzahl distinct Optimierungs-Aufgaben (1 Eintrag pro Issue-Kind). Gleicher
  // Begriff wie auf /scan/results bucketCount — Header sprechen jetzt überall
  // dieselbe Sprache: "X Aufgaben · Y Stellen". (12.05.2026 User-Vertrauens-Fix)
  ...
  return (
    <>
      ...
      >
          ...
          {/* Phase 2: Shared MetricPillBar — Pro-Mode size="sm" (kompakt). */}
          {!isNewScan && lastScan && (
            <MetricPillBar
              avgTtfbMs={avgTtfbMs}
