      ...
      <main>
        ...
        <section style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px 64px" }}>
          <h2 style={{ fontSize: "clamp(20px, 3vw, 28px)", fontWeight: 700, margin: "0 0 28px", letterSpacing: "-0.02em" }}>
            Zwei verschiedene Probleme — eine Diagnose.
          </h2>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(240px, 1fr))", gap: 10 }}>
            {[
              { title: "Besucher sehen eine Fehlermeldung", desc: "Diese Seite ist nicht erreichbar — Besucher kommen gar nicht erst auf deine Website und springen sofort ab." },
              { title: "Google findet deine Seite nicht", desc: "Deine Website ist online, aber in den Suchergebnissen taucht sie nicht auf. Kein Traffic, keine Anfragen." },
              { title: "Oft ein einziger technischer Fehler", desc: "Eine falsche Einstellung, ein DNS-Problem oder eine abgelaufene Domain — die KI findet es in Sekunden." },
            ].map((item) => (
        ...
        <section style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px 64px" }} id="ursachen">
          ...
          <h2 style={{ fontSize: "clamp(20px, 3vw, 28px)", fontWeight: 700, margin: "0 0 12px", letterSpacing: "-0.02em" }}>Warum wird eine Website nicht gefunden?</h2>
