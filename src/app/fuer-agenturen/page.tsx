    ...
    <>
      ...
      <main style={{ color: T.text }}>
        ...
        {/* ─── TRUST-SECTION — "Agenturen kaufen Sicherheit, nicht Features" ───
            ...
            Default-Read-Only-Plugin + DSGVO/Aktivitäts-Log als Haftungsschutz.
            Verschoben von / hierher (11.05.2026) — gehört auf die Agency-Page,
            nicht in die generische Landing. "Sie"-Form per Konvention. */}
          ...
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: 48, maxWidth: 720, marginInline: "auto" }}>
              ...
              <p style={{ margin: 0, fontSize: 16, color: "rgba(255,255,255,0.55)", lineHeight: 1.65 }}>
                Falsche Fixes machen Sites kaputt, verschlechtern Accessibility-Scores oder SEO — und kosten Sie den Kunden.
                Deshalb haben wir uns für ein <strong style={{ color: "#fff" }}>Default-Read-Only-Plugin</strong> entschieden: alle Scans sind reine Diagnose ohne Schreibzugriff. Auto-Fixes laufen <strong style={{ color: "#fff" }}>nur auf Ihren expliziten Klick im Dashboard</strong>.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  body: "Diagnose-Scans sind reine Lese-Operationen — kein FTP, kein Passwort-Sharing, kein Dateisystem-Zugriff. KI-Auto-Fix schreibt nur das, was Sie im Dashboard explizit freigeben.",
                ...
                },
                {
                  ...
                  body: "Barrierefreiheitsstärkungsgesetz seit Juni 2025 Pflicht für fast alle Unternehmens-Sites. Unsere Scans liefern Ihnen den Audit-Beleg + AVV-Mustervorlage zum Vorzeigen.",
            ...
            <p style={{ margin: "32px auto 0", maxWidth: 720, textAlign: "center", fontSize: 13.5, color: "rgba(255,255,255,0.42)", lineHeight: 1.7 }}>
              ...
              keine automatischen Schreiboperationen. KI-Auto-Fix führt nur die Änderungen aus, die Sie
              im Dashboard explizit per Klick freigeben. <strong style={{ color: "rgba(255,255,255,0.65)" }}>Sie behalten die volle Kontrolle.</strong>
            </p>
          </div>
        </section>
