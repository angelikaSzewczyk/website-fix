            ...
            <>
              ...
              {(() => {
                const tiles = [
                  ...
                  { label: "Hinweise",          val: issues.filter(i => i.severity === "green").length,   col: D.cyan,  bg: D.cyanBg,  bdr: D.cyanBdr,  icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg> },
                ];
                return (
