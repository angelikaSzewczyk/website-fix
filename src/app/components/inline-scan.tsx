  ...
  async function handleScan(event: React.FormEvent) {
    ...
    try {
      ...
      if (data.success) {
        ...
        // V2: vollständige Audit-Evidence zusätzlich für die Results-Seite
        // derselben Browser-Session sichern. StoredScan bleibt bewusst kompakt,
        // aber Statuscodes / Discovery-Metriken dürfen beim Redirect nicht
        // verloren gehen.
        try {
          sessionStorage.setItem(
            "wf_scan_raw_evidence",
            JSON.stringify({
              url: cleanUrl,
          ...
          // Storage darf den erfolgreichen Scan nie blockieren.
        }
