    ...
    <div style={{
      ...
      <div style={{ flex: 1, maxWidth: 860, width: "100%", margin: "0 auto", padding: "52px 24px 96px" }}>
        ...
        <div style={{
          ...
          borderRadius: 20,
          boxShadow: "0 0 50px rgba(37,99,235,0.06), 0 24px 64px rgba(0,0,0,0.5)",
          overflow: "hidden",
        }}>
          ...
          <div style={{
            padding: "28px 40px",
            background: "linear-gradient(90deg, rgba(37,99,235,0.18) 0%, rgba(37,99,235,0.04) 50%, transparent 100%)",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              <div style={{
                ...
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                  stroke="#7aa6ff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
