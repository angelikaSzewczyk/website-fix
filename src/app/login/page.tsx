    ...
    <>
      ...
      <main style={{ minHeight: "80vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 24px" }}>
        <div style={{ width: "100%", maxWidth: 380, textAlign: "center" }}>
          <h1 style={{ fontSize: 26, fontWeight: 700, margin: "0 0 8px", letterSpacing: "-0.02em" }}>Einloggen</h1>
          <p style={{ fontSize: 14, color: "rgba(255,255,255,0.4)", margin: "0 0 36px", lineHeight: 1.6 }}>
            Zugang zu Dashboard und Scan-Historie.
          </p>
          ...
          <p style={{ fontSize: 12, color: "rgba(255,255,255,0.25)", margin: "20px 0 0", lineHeight: 1.6 }}>
            Kein Account nötig — einfach einloggen.
          </p>
        </div>
      </main>
    </>
