...
function ResultsInner() {
  ...
  const diagnosis = buildDiagnosis(scan);
      ...
      <main className="wf-results-shell">
        <div className="wf-results-container">
          ...
          {diagnosis.primaryFinding && (
            <PrimaryFinding finding={diagnosis.primaryFinding} />
          )}

          <FindingList findings={diagnosis.findings} />

          <section className="wf-results-performance">
            <div>
              <span className="wf-results-eyebrow">Performance</span>
              <h2>Core Web Vitals separat messen</h2>
              <p>
                Lighthouse-Werte werden nicht aus dem normalen Website-Scan
                geschätzt, sondern separat über Google PageSpeed Insights
                gemessen.
              </p>
            </div>
