  ...
  return (
    ...
    >
      ...
      <p className="wf-results-lead">
        ...
        {discoveredMore ? (
          <>
            <strong>{diagnosis.pagesChecked} Seiten geprüft</strong>{" "}
            · {diagnosis.discoveredUrls} interne URLs entdeckt
          </>
        ) : (
          <>
      ...
      {discoveredMore && (
        <p className="wf-results-scope-note">
          Kostenloser Check: WebsiteFix entdeckt den URL-Bestand, analysiert aber nur die angezeigten Seiten vollständig. Nicht geprüfte URLs werden weder als fehlerhaft noch als fehlerfrei bewertet.
        </p>
      )}
    </header>
  );
