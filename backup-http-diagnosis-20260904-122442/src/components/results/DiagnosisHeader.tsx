    ...
    >
      ...
      {discoveredMore && (
        <p className="wf-results-scope-note">
          Kostenloser Check: Startseite plus ein begrenzter Teil der Unterseiten. Nicht geprüfte Seiten werden nicht als fehlerfrei bewertet.
        </p>
      )}
    </header>
  );
